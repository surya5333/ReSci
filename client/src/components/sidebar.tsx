...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div
      className={cn(
        "w-64 bg-white dark:bg-slate-800 shadow-lg border-r border-slate-200 dark:border-slate-700 flex flex-col",
        className,
      )}
    >
      {/* Logo & Brand */}
      ...
      <div className="p-4 border-t border-slate-200 dark:border-slate-700">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 truncate"></p>
          </div>
        </div>
      </div>
    </div>
